#!/usr/bin/python3
"""Module defining the Place class for the HBNB project."""
import os
...
"""Table representing the many-to-many relationship
...
class Place(BaseModel, Base):
    ...
    if os.getenv('HBNB_TYPE_STORAGE') == 'db':
        ...
        def amenities(self, value):
            """Adds an amenity to this Place if it is not already present."""
